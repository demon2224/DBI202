...
********************************************************************************/
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'PE_DBI202_LAB3')
BEGIN
	ALTER DATABASE [PE_DBI202_LAB3] SET OFFLINE WITH ROLLBACK IMMEDIATE;
	ALTER DATABASE [PE_DBI202_LAB3] SET ONLINE;
	DROP DATABASE [PE_DBI202_LAB3];
END

GO

CREATE DATABASE [PE_DBI202_LAB3]
GO
