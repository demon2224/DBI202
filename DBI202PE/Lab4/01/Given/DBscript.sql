...
********************************************************************************/
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'PE_DBI202.Lab4')
BEGIN
	ALTER DATABASE [PE_DBI202.Lab4] SET OFFLINE WITH ROLLBACK IMMEDIATE;
	ALTER DATABASE [PE_DBI202.Lab4] SET ONLINE;
	DROP DATABASE [PE_DBI202.Lab4];
END

GO

CREATE DATABASE [PE_DBI202.Lab4]
GO
